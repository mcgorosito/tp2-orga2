...
Zigzag_asm:
    ...
    add r12, 4*px_size         ; NOTA: src siempre está 4 pos adelantada
        ...
        ; DUMMY INSTRUCTIONS
        movdqa xmm3, xmm4
        punpcklwd xmm3, xmm4       ; xmm0  -> |sumaApx2 sumaRpx2 sumaGpx2 sumaBpx2|
        punpckhwd xmm4, xmm4       ; xmm1  -> |sumaApx3 sumaRpx3 sumaGpx3 sumaBpx3|
        movdqa xmm5, xmm6
        punpcklwd xmm5, xmm6      ; xmm10 -> |sumaApx4 sumaRpx3 sumaGpx4 sumaBpx4|
        punpckhwd xmm5, xmm6      ; xmm11 -> |sumaApx5 sumaRpx5 sumaGpx5 sumaBpx5|
        ...
        ;DUMMY INSTRUCTIONS
        packusdw xmm3, xmm4         ; |Apx3T Rpx3T Gpx3T Bpx3T|Apx2T Rpx2T Gpx2T Bpx2T|
        packusdw xmm5, xmm6         ; |Apx5T Rpx5T Gpx5T Bpx5T|Apx4T Rpx4T Gpx4T Bpx4T|
