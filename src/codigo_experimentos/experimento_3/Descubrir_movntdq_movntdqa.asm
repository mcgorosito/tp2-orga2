...
mascaraRellenoParaAlinear: times 8 db 0x00
...
Descubrir_asm:
	...
	movdqa xmm12, [mascaraShuffleHigh]
	...
	sub r8, 8        ; para equiparar con movdqu
...
.ciclo:
	...
	; Cargar 8 px de src    
    movntdqa xmm0, [rdi+rcx*8]       ; xmm0 -> |A3 R3 G3 B3|A2 R2 G2 B2|A1 R1 G1 B1|A0 R0 G0 B0|
    movntdqa xmm1, [rdi+(rcx+2)*8]   ; xmm1 -> |A7 R7 G7 B7|A6 R6 G6 B6|A5 R5 G5 B5|A4 R4 G4 B4|
...
; Desencriptar
    ; Cargar últimos 8 px
    movntdqa xmm2, [rax]    ; xmm2 -> ultimos 4 px
    sub rax, 16
    movntdqa xmm3, [rax]    ; xmm3 -> anteultimos 4 px
    sub rax, 16
	...
	movntdq [rsi+rcx*8], xmm0     ; guardar en destino
	movntdq [rsi+(rcx+2)*8], xmm1
