...
Ocultar_asm:
	...
	sub r12, 8	         ; para equiparar con movdqu
...
ciclo:
	...
	movntdqa xmm1, [rsi]            ; xmm1 -> |A3 R3 G3 B3|A2 R2 G2 B2|A1 R1 G1 B1|A0 R0 G0 B0|
	movntdqa xmm2, [rsi+4*px_size]  ; xmm2 -> |A7 R7 G7 B7|A6 R6 G6 B6|A5 R5 G5 B5|A4 R4 G4 B4|
    ...
    movntdqa xmm3, [rax]              ; |px size-1|px size-2|px size-3|px size-4|
    movntdqa xmm4, [rax-4*px_size]
	...
	movntdqa xmm3, [rdi]              ; levantar 8 px de src
	movntdqa xmm4, [rdi+4*px_size]
	...
	movntdq [rdx], xmm1              ; guardar en destino
	movntdq [rdx+4*px_size], xmm2
