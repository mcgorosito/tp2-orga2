...
Zigzag_asm:
	...
	mov rdx, width          ; copiar width en rdx (para poder modificarla)
		...
		movdqa [r13+8*px_size], marco
		movdqa [r13+12*px_size], marco
		add r13, 16*px_size      ; Avanzar pos de memoria 4 pixeles
		add r14, 16              ; Incrementar contador
		cmp r14, rdx
...
ciclo:
	...
	mov rdx, width
	sub rdx, 16                   ; menos 18 del final y 2 que adelanté

		.cicloFilas3:
		movdqu xmm0, [r12]      ; | px5 | px4 | px3 | px2 | (no alineada)
		movdqu xmm2, [r12+4*px_size]
		movdqu xmm3, [r12+8*px_size]
		movdqu xmm4, [r12+12*px_size]
		...
		movdqa [r13+8*px_size], xmm3
		movdqa [r13+12*px_size], xmm4
		add r12, 16*px_size       ; Avanzar pos de memoria 4 pixeles
		add r13, 16*px_size
		add r14, 16               ; Incrementar contador
	...
	movdqu xmm2, [r12]
	movdqu xmm3, [r12+4*px_size]
	movdqu xmm4, [r12+8*px_size]
	movdqa xmm0, [r12+10*px_size]       ; xmm0 -> | px63 | px62 | px61 | px60 |
	...
	movdqa [r13], xmm2
	movdqa [r13+4*px_size], xmm3       ; Guardar px en memoria
	movdqa [r13+8*px_size], xmm4
	movdqa [r13+12*px_size], xmm0
	...
	sub rdx, 16
		...
		movdqa xmm2, [r12+8*px_size]
		movdqa xmm3, [r12+12*px_size]
		movdqu [r13], xmm0      ; Moverlos a destino -> NO ALINEADO
		movdqu [r13+4*px_size], xmm1
		movdqu [r13+8*px_size], xmm2
		movdqu [r13+12*px_size], xmm3
	...
	movdqa xmm0, [r12]
	movdqa xmm1, [r12+px_size*4]
	movdqa xmm2, [r12+px_size*8]
	movdqu [r13], xmm0
	movdqu [r13+px_size*4], xmm1
	movdqu [r13+px_size*8], xmm2
	movq [r13+px_size*12], marco
