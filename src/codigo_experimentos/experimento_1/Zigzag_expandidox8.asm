...
ciclo:
	...
	sub rdx, 4                   ; menos 6 del final y 2 que adelanté
		...
		jne .cicloFilas3a          ; Si es igual, seguir
	...
	sub rdx, 4                   ; menos 6 del final y 2 que adelanté
		...
		cmp r14, rdx             ; comparar contador con width-6. Si es distinto, volver a cicloFila3
		jne .cicloFilas3b          ; Si es igual, seguir
	...
	sub rdx, 4                   ; menos 6 del final y 2 que adelanté
		...
		cmp r14, rdx             ; comparar contador con width-6. Si es distinto, volver a cicloFila3
		jne .cicloFilas3c          ; Si es igual, seguir
	...
	sub rdx, 4                   ; menos 6 del final y 2 que adelanté
		...
		cmp r14, rdx             ; comparar contador con width-6. Si es distinto, volver a cicloFila3
		jne .cicloFilas3d          ; Si es igual, seguir
	...
	sub rdx, 4                   ; menos 6 del final y 2 que adelanté
		...
		cmp r14, rdx             ; comparar contador con width-6. Si es distinto, volver a cicloFila3
		jne .cicloFilas3e          ; Si es igual, seguir
	...
	sub rdx, 4                   ; menos 6 del final y 2 que adelanté
		...
		cmp r14, rdx             ; comparar contador con width-6. Si es distinto, volver a cicloFila3
		jne .cicloFilas3f         ; Si es igual, seguir
	...
	sub rdx, 4                   ; menos 6 del final y 2 que adelanté
		...
		cmp r14, rdx             ; comparar contador con width-6. Si es distinto, volver a cicloFila3
		jne .cicloFilas3g          ; Si es igual, seguir
	...
	sub rdx, 4                   ; menos 6 del final y 2 que adelanté
		...
		cmp r14, rdx             ; comparar contador con width-6. Si es distinto, volver a cicloFila3
		jne .cicloFilas3h          ; Si es igual, seguir
